...
// Automatically use production backend in deployed Netlify,
// else fallback to localhost when developing
...
export default function BrowseCounselors() {
  ...
  const fetchCounselors = async () => {
    try {
      ...
      console.error('Counselors error:', err?.response?.data || err.message);
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gray-100 py-8">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Browse and book appointments with our counselors.</p>
        </div>
        {error && (
                ...
                <div className="p-6">
                  <div className="space-y-3 mb-6">
                    <div>
                      ...
                      <p className="text-gray-800 text-lg">{counselor.specialization || 'N/A'}</p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="text-green-600 text-xl font-bold">
                        {counselor.hourlyRate ? `₹${counselor.hourlyRate}/hr` : 'N/A'}
                      </p>
                    </div>
                    <div>
                      <label className="text-gray-600 font-semibold text-sm">License:</label>
                      <p className="text-gray-800">{counselor.licenseNumber || 'N/A'}</p>
                    </div>
                  </div>
                  <button
